  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open f1ck_OA when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "f1ck_OA will launch automatically on system startup"
                : "f1ck_OA will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
