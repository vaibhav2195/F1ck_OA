...
import { shouldUsef1ck_OAAPI } from "@/lib/functions/f1ck_OA.api";
  ...
  const vad = useMicVAD({
    ...
    onSpeechEnd: async (audio) => {
      try {
        ...
        if (!selectedSttProvider.provider && !usef1ck_OAAPI) {
        ...
        if (!providerConfig && !usef1ck_OAAPI) {
        ...
        transcription = await fetchSTT({
          provider: usef1ck_OAAPI ? undefined : providerConfig,
